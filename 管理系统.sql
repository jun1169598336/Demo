...
--登陆表
insert into UserLogin values('ZJL','123456',1)
insert into UserLogin values('RSJL','123456',2)
insert into UserLogin values('CWJL','123456',3)
insert into UserLogin values('XSZG','123456',4)
insert into UserLogin values('YFZG','123456',5)
insert into UserLogin values('YG','123456',6)
...
--部门表
insert into DepartmentInfo values('总经理')
...
select DutyName,userlogin.*,InfoName,InfoSex,InfoState from userlogin,DutyInfo,InfoTable where userlogin.DutyId=DutyInfo.DutyId
 and  InfoTable.Userid=UserLogin.Userid and InfoTable.DutyId=DutyInfo.DutyId
 go
insert  into InfoTable values('柳林军',20,'男','1999.11.1','147852369632541788','12345123957','河南省郑州市','19231234121@qq.com',getdate(),'','3',1,1,1,'15000',1)
insert  into InfoTable values('王莹莹',18,'男','2001.11.1','147852369632541785','12345123454','河南省郑州市','11231234121@qq.com',getdate(),'','2',3,2,2,'7000',1)
insert  into InfoTable values('位伟峰',20,'女','1999.10.1','145236525632458712','12345123456','河南省郑州市','10231234121@qq.com',getdate(),'','3',4,3,3,'7000',1)
...
insert  into InfoTable values('宋玉鑫',24,'女','1995.5.1','147852369987456123','12345123453','河南省郑州市','10231234124@qq.com',getdate(),'','3',2,4,4,'6000',1)
insert  into InfoTable values('白亚军',20,'男','1999.10.1','147852369987456714','12345123483','河南省郑州市','10231234174@qq.com',getdate(),'','1',2,6,6,'4000',1)
insert  into InfoTable values('李明',20,'男','1999.7.1','147852369987456185','12345123473','河南省郑州市','10231234824@qq.com',getdate(),'','3个月',2,6,6,'3000',1)
insert  into InfoTable values('谷相搏',22,'男','1997.12.13','213784216424624242','4134213411','河南省郑州市','142143242424@qq.com','','','1',4,1,3,'6000',1)
insert  into InfoTable values('杨申',20,'女','1989.10.1','234321456789231234','9876543212','河南省郑州市','1431412421@qq.com',getdate(),'','3',4,3,3,'7000',1)
insert  into InfoTable values('李彬辉',27,'男','1992.6.1','3242142432453545','34523231231','河南省郑州市','523424244124@qq.com',getdate(),'','2',4,5,5,'5000',1)
...
insert  into InfoTable values('谭顺顺',18,'男','2001.11.1','123423133432423','345423113','河南省郑州市','324532455345@qq.com','','','1',4,3,2,'7000',1)
insert  into InfoTable values('潘武豪',20,'女','1999.10.1','75432112342324213','43523123142','河南省郑州市','345353535353@qq.com',getdate(),'','2',4,4,3,'7000',1)
insert  into InfoTable values('田松茂',27,'男','1992.6.1','21231324231234234','5523422323','河南省郑州市','53453532@qq.com',getdate(),'','2',4,4,6,'5000',1)
...
insert  into InfoTable values('张建行',20,'男','1999.10.1','2432452342655635','653524123','河南省郑州市','14141344245434@qq.com',getdate(),'','2',4,5,6,'4000',1)
...
insert  into InfoTable values('于超越',18,'男','2001.11.1','134321235335','3214364342','河南省郑州市','42342312@qq.com','','','1',4,3,4,'7000',1)
insert  into InfoTable values('石金涛',20,'女','1999.10.1','45362342411231','13253443','河南省郑州市','124321312@qq.com',getdate(),'','2',4,4,6,'7000',1)
insert  into InfoTable values('李浩东',27,'男','1992.6.1','3453424131231534','124124346','河南省郑州市','345312312@qq.com',getdate(),'','2',5,4,6,'5000',1)
insert  into InfoTable values('陈路明',24,'女','1995.5.1','546312123123131','3425463242','河南省郑州市','3452312123@qq.com',getdate(),'','2',5,5,6,'6000',1)
insert  into InfoTable values('冯琦',20,'男','1999.10.1','5345231231231423','2523534634','河南省郑州市','3452313123@qq.com',getdate(),'','3',5,5,6,'4000',1)
insert  into InfoTable values('许备备',20,'男','1999.7.1','4231231423531231','45645241312','河南省郑州市','345212132@qq.com',getdate(),'','3个月',5,6,6,'3000',1)
insert  into InfoTable values('朱思南',27,'男','1992.6.1','443531231252313','3523121423','河南省郑州市','4565234213@qq.com',getdate(),'','1',5,3,5,'5000',1)
insert  into InfoTable values('彭林',24,'女','1995.5.1','3245423123123131','4352312452','河南省郑州市','2314312313@qq.com',getdate(),'','2',5,5,6,'6000',1)
insert  into InfoTable values('李梦凡',21,'男','1998.10.1','123252341224354','1231252342','河南省郑州市','34312324@qq.com',getdate(),'','3',5,5,6,'4000',1)
insert  into InfoTable values('张文政',22,'男','1997.7.1','531244345124','435634123','河南省郑州市','456453422@qq.com',getdate(),'','3个月',5,5,6,'3000',1)

insert  into InfoTable values('孙悟空',20,'男','1999.10.1','24324523124635','623412123','河南省郑州市','24532145434@qq.com',getdate(),'','2',5,5,6,'4000',1)
insert  into InfoTable values('娜美',20,'女','1999.7.1','4135123231331','31234623','河南省郑州市','456231232313@qq.com',getdate(),'','3个月',5,5,6,'3000',1)
insert  into InfoTable values('罗宾',18,'女','2001.11.1','134321232335','3214234342','河南省郑州市','423345312@qq.com','','','1',5,3,4,'7000',1)
insert  into InfoTable values('汉库克',20,'女','1999.10.1','453612311231','112343','河南省郑州市','12312312@qq.com',getdate(),'','2',5,4,6,'7000',1)
insert  into InfoTable values('萧炎',27,'男','1992.6.1','3453424134231534','1242344346','河南省郑州市','3434512312@qq.com',getdate(),'','2',5,4,6,'5000',1)
insert  into InfoTable values('灵帝',24,'女','1995.5.1','5463121233131','342123242','河南省郑州市','312323@qq.com',getdate(),'','2',5,5,6,'6000',1)
insert  into InfoTable values('吕布',20,'男','1999.10.1','5345231531231423','25223434634','河南省郑州市','34513123@qq.com',getdate(),'','3',5,5,6,'4000',1)
insert  into InfoTable values('貂蝉',27,'女','1992.6.1','4435312313452313','35223421423','河南省郑州市','4534534213@qq.com',getdate(),'','1',5,3,5,'5000',1)
insert  into InfoTable values('大乔',24,'女','1995.5.1','3245423134523131','432312452','河南省郑州市','2314234313@qq.com',getdate(),'','2',5,5,6,'6000',1)
insert  into InfoTable values('小乔',21,'女','1998.10.1','123252345224354','12352342','河南省郑州市','2344@qq.com',getdate(),'','3',5,5,6,'4000',1)
insert  into InfoTable values('蔡文姬',22,'女','1997.7.1','531234545124','432344123','河南省郑州市','456423422@qq.com',getdate(),'','3个月',5,5,6,'3000',1)
...
insert into MoneyTable values(6,2,'0',2,2)
...
create table ClockInfo(
   ...
   InfoId int references InfoTable(InfoId),--人员信息表外键
...
insert  into ClockInfo values(7,'',2)
insert  into ClockInfo values(6,'2019/11/29 07:59:25',1)
...
select InfoName,ClockInfo.*,Dep,DutyName from InfoTable,ClockInfo,DepartmentInfo,DutyInfo where ClockInfo.InfoId=InfoTable.InfoId and DepartmentInfo.DepId=InfoTable.DepId
 and DutyInfo.DutyId=InfoTable.DutyId
...
insert into LeaveInfo values (6,3,'2019/9/9 8:00:00','2019/9/11 8:00:00','回家参加婚礼',1)
insert into LeaveInfo values (8,4,'2019/9/10 12:00:00','2019/9/14 12:00:00','家里有急事',2)
...
as
declare @sql varchar(max)
set @sql='select LeaveInfo.*,DepartmentInfo.Dep,InfoName from LeaveInfo,DepartmentInfo,InfoTable 
where LeaveInfo.InfoId=InfoTable.InfoId and LeaveInfo.DepId=DepartmentInfo.DepId '
if @DepId<>0
...
INSERT INTO PersonSaleInfo VALUES('张三','酒店管理系统',20000,200)
...
create table IncomeInfo(
 ...
 SaleId int references SaleInfo(SaleId)
)
go

insert into IncomeInfo values('10月份','22000',1)
insert into IncomeInfo values('10月份','20000',2)

select * from IncomeInfo,SaleInfo where SaleInfo.SaleId=IncomeInfo.IncomeId
...
--查询每个部门
IF EXISTS(SELECT * FROM SYS.procedures WHERE NAME='SELdep')
drop proc SELdep
go
create proc SELdep
as
	SELECT  DepartmentInfo.Dep,count(DepartmentInfo.Dep) as value
FROM      dbo.InfoTable INNER JOIN
                dbo.DepartmentInfo ON dbo.InfoTable.DepId = dbo.DepartmentInfo.DepId group by DepartmentInfo.Dep
go
	exec SELdep